...
public class MyFirebaseMessaging extends FirebaseMessagingService {
    ...
    public void onMessageReceived(RemoteMessage remoteMessage) {
        ...
        SharedPreferences preferences=getSharedPreferences("Gamal",MODE_PRIVATE);
    ...
    private void SendOreNotification(RemoteMessage remoteMessage) {
        ...
        Notification.Builder builder=oreoNotification.getorNotification(title,body,pendingIntent,defaultsound,icon);
        int i=0;
        if (j>0)
        {
            i=j;
